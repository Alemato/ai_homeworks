...
def main_chess_game():
    ...
    search_algorithm_a1 = MinMaxAlphaBetaPruningHlCut(game=game, heuristic=heuristic_a1, h0_cut=heuristic_a2, k=5,
                                                      max_depth=6)
    search_algorithm_a2 = MinMaxAlphaBetaPruningHlCut(game=game, heuristic=heuristic_a1, h0_cut=heuristic_a2, k=5,
                                                      max_depth=6)
